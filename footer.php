<footer class="footer">
    <div class="container">
        <div class="hydra_footer row gy-0 gx-0 justify-content-end">
            ...
            <div class="col-md-6 hydra_footer1">
                <div class="row gy-0 gx-0">
                    <div class="col-md-6 footer__info">
                        <ul>
                            <li><a href="#">Dănceni, Republica Moldova</a></li>
                            <li><a href="#">contact@hydraprim.md</a></li>
                            <li><a href="#">+373 78 363 555</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6 footer__info1">
                        <ul class="pages_footer">
    ...
    <div class="copyright">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <p class="text-white">© 2024 Hydra Prim | All rights reserved | Made by MinCode Group</p>
                <div class="cards">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="98" height="29" viewBox="0 0 98 29" fill="none">
